...
_config = {
    ...
    'DATA_DIR': os.environ.get('GENOMEKIT_DATA_DIR', appdirs.user_data_dir('genome_kit')),
}
...
def get_appris_version(annotation):
    if any(x in annotation for x in ["Sscrofa11.1.98", ".m38.v"]):
        return "2019_09.v29"
    elif any(x in annotation for x in ["gencode.v29", "gencode.vM19", "ncbi_refseq.v109"]):
        return "2018_12.v28"
